        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-10 profile-mine">
                    <h4 class="xcspace-profile-heading"><span><?php if(isset($user_info)){if($one_user_info['id']==$user_info['id']){ echo "我";}else{ echo "他"; }}else{ echo "他";} ?>的话题</span><span class="pull-right">总数&nbsp;<?php echo $member_info_count;?></span>
                    </h4>
