        ...
        <div class="bordert">
            ...
            <div class="col-md-6 col-md-offset-3 bg-white login-wrap mt30">
                ...
                <p class="title-description">
                  <a href="javascript:;" ><?php if(isset($_SESSION['qq_info'])) echo $_SESSION['qq_info']['nickname'];?></a> 您正在使用 <span class="icon-sn-qq"></span> <a href target="_blank" >腾讯 QQ 注册登录</a>
                </p>
                <div>
                    <?php if( isset($errMsg) ): ?>
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="tab1">
                            <form method="POST" role="form" action="/qqLogin/bindNoUser" >
                        ...
                        <div role="tabpanel" class="tab-pane" id="tab2">
                            <form method="POST" action="/qqLogin/bindHaveUser" role="form">
                                <input type="hidden" class="form-control" name="<?php echo $this->token_name;?>" value="<?php echo $this->token_hash;?>">
