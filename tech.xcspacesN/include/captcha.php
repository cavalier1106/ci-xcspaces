...
class LfsCaptcha {
    public $width  = 80;
    public $height = 30;
	public $glbVerifySeed = "ABCDEFGHIJKLMNPQRSTUVWXYZ0123456789";
	public $strLength = 5;
    ...
    public function __construct($config = array()) {
			if(intval($config['width'])>80) $this->width = $config['width'];
			if(intval($config['height'])>30) $this->height = $config['height'];
			if($this->width > 80 || $this->height>30) {
				$this->scale = 1;
			}
